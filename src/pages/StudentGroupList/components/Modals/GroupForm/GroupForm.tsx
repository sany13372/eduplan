...
import { BaseGroupInfo } from '@src/pages/StudentGroupList/model/types';
import { eduGroupSchema } from '@src/pages/StudentGroupList/model/validation';
  ...
  return (
    <div className="flex flex-col space-y-8">
      <div className="flex justify-between">
        ...
        <Button
          onClick={() => groupStudentModalApi.close()}
